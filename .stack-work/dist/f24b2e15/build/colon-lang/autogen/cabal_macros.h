...
/* package colon-lang-0.1.0.0 */
#ifndef VERSION_colon_lang
#define VERSION_colon_lang "0.1.0.0"
#endif /* VERSION_colon_lang */
#ifndef MIN_VERSION_colon_lang
#define MIN_VERSION_colon_lang(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
